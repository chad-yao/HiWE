...
class EpisodicDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        self.way_point_root='/waypoints_awe'  # or '/waypoints_ssl_hwe' for hierarchical
        print(self.way_point_root)
    ...
    def __getitem__(self, index):
        ...
        with h5py.File(dataset_path, "r") as root:
            ...
            if self.use_waypoint and self.constant_waypoint is None:
                waypoints = root[self.way_point_root][()]
        ...
        return image_data, qpos_data, action_data, is_pad,raw_data
